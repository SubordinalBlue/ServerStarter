...
* Reduced size of the server files when download and when uploading to a server.
...
## Format
See `server-setup-config.yaml` for an example file how this file should be layed out.
